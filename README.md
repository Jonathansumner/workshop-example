...
- docker compose down -v => make sure any docker containers are not running
...
- docker compose up -d --remove-orphans => spin up all containers and ensure there are no straggling containers
*/
